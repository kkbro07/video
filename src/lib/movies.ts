    ...
    seasons: [
      {
        season: 1,
        episodes: [
          { episode: 1, title: 'Episode 1', description: 'Arisu and his friends run from the police, only to find themselves in a deserted Tokyo. They are forced to play a deadly game to survive.', videoUrl: '/video/Alice_in_Borderland/s1/E1.mp4' },
